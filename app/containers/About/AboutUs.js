...
export default React.createClass({
  ...
  componentWillBeVisibleOnPageRouter() {
    if (window.analytics) window.analytics.trackView('About Us');
  },
    ...
    return (
      <PageWithBar title="關於" hasBack pageRouterkey="about" style={this.props.style}>
        <div style={{ padding: '4px 12px 24px' }}>
          ...
          <p style={{ lineHeight: '28px' }}>從上了大學以來，我們陸續做了「行事曆排課工具」、「社團商品訂購系統」、「活動抽獎系統」、「各式活動大頭貼產生器」、「宿舍日用品團購網站」、「原文書團購網站」等各式開源服務，隨著時間過去，專案的規模與數量也日益增長，在最後結合而成 Colorgy 平台，希望可以讓校園生活更歡樂繽紛，為校園與同學們創造更多價值。</p>
